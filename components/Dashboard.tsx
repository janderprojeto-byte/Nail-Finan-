                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-purple-50/50 p-8 rounded-[40px] border border-purple-100 space-y-6">
                            ...
                            <div className="pt-4 border-t border-purple-100">
                                ...
                                <p className="text-[9px] text-purple-400 mt-2 italic font-medium">As sugestões automáticas só aparecerão a partir desta data.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-emerald-50/50 p-8 rounded-[40px] border border-emerald-100 space-y-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-emerald-600 font-bold">Em quantos meses você quer resgatar o lucro do Stúdio?</p>
                                </div>
                            </div>
                            <div className="flex flex-wrap gap-2">
